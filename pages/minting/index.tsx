    ...
    return (
        <SwiperOptionDiv>
            <div className='main-div'>
                <AiFillCaretLeft className='ctl-icon left' onClick={() => {
                    swiper.slidePrev();
                }}></AiFillCaretLeft>
                ...
                <AiFillCaretRight className='ctl-icon right' onClick={() => {
                    swiper.slideNext();
                }}></AiFillCaretRight>
            </div>
            <div className='info'>
                <span>{snapIndex+1} / {sliceLengh}</span>
            </div>
        </SwiperOptionDiv>
...
const Minting = () => {
    ...
    return (
        <Wrapper>
            <Container>
                <OptionsDiv>
                    <SwiperOption rndFlag={rndFlag} title='Background' imgs={BACKGROUNDS} setVal={setValBackground} flag={0}></SwiperOption>
                    <SwiperOption rndFlag={rndFlag} title='Shell' imgs={SKINS} setVal={setValSkins} flag={1}></SwiperOption>
                    <SwiperOption rndFlag={rndFlag} title='Eyes' imgs={EYES} setVal={setValEyes} flag={2}></SwiperOption>
                    <SwiperOption rndFlag={rndFlag} title='Mouth' imgs={MOUTHS} setVal={setValMouths} flag={3}></SwiperOption>
                    <SwiperOption rndFlag={rndFlag} title='Shirt' imgs={SHIRTS} setVal={setValShirt} flag={4}></SwiperOption>
                    <SwiperOption rndFlag={rndFlag} title='Head' imgs={HEADS} setVal={setValHead} flag={5}></SwiperOption>
                    <SwiperOption rndFlag={rndFlag} title='Accessories' imgs={ACCESSORIES} setVal={setValAccessoires} flag={6}></SwiperOption>

                    <ControlButtons>
                        <button onClick={() => setRndFlag(!rndFlag)}>
                            Random
                        </button>
